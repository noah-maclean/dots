-- snacks - a number of QOL plugins
return {
	"folke/snacks.nvim",
	priority = 1000,
	lazy = false,
	opts = {
		...
		dashboard = { enabled = false }, -- alternative to alpha (requires lots of config)
		explorer = { -- alternative to neo-tree
			enabled = true,
			replace_netrw = true,
		},
		...
		notifier = { -- pretty vim-notify (notifications)
			enabled = true,
			timeout = 3000, -- notifications dismiss after 3 secs
		},
		...
		terminal = {
			...
			keys = {
				q = "hide",
				term_normal = { -- press double escape to be able to exit terminal
					"<esc>",
					function(self)
